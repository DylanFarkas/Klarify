/**
 * @fileoverview EmptyPrioritizationState — Estado vacío del Agente 3.
 *
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center animate-[fadeIn_0.3s_ease-out]">
      ...
      <p className="mb-8 max-w-sm text-sm leading-relaxed text-muted">
        Para priorizar el backlog, primero debes completar el Agente 2 y aprobar tus épicas e historias de usuario.
      </p>
