  ...
  return (
    <div className="mx-auto flex max-w-lg flex-col items-center rounded-2xl border border-border bg-surface/80 px-8 py-12 text-center shadow-sm">
      <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-primary/10">
        <svg className="h-7 w-7 text-primary" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          <path
            fillRule="evenodd"
      ...
      <h2 className="text-xl font-bold text-foreground">Exportación a GitHub</h2>
      <p className="mt-3 text-sm leading-relaxed text-muted">
        Exporta épicas, historias de usuario, criterios de aceptación, estimaciones, prioridades y
        sprints directamente a GitHub Projects. Disponible en el plan Pro.
      </p>
      <Link
        href="/#pricing"
