          ...
          {!isApproved && (
            <div className="mt-3 flex items-center gap-2 opacity-100 lg:opacity-0 lg:group-hover:opacity-100 transition-opacity">
              <button
                ...
                className="inline-flex items-center gap-1 rounded-lg px-2.5 py-1 text-xs font-medium text-white/50 hover:text-white hover:bg-white/10 transition-all cursor-pointer"
              >
              ...
              <button
                ...
                className="inline-flex items-center gap-1 rounded-lg px-2.5 py-1 text-xs font-medium text-white/50 hover:text-red-400 hover:bg-red-500/10 transition-all cursor-pointer"
              >
                <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
