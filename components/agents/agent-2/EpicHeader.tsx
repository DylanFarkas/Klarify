        ...
        <>
          ...
          {!isApproved && (
            <button
              ...
              className="inline-flex items-center gap-1 self-start rounded-lg px-2.5 py-1 text-xs font-medium text-muted hover:text-foreground hover:bg-surface-hover transition-all cursor-pointer opacity-100 lg:opacity-0 lg:group-hover:opacity-100"
            >
