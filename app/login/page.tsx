...
export default function LoginPage() {
  ...
  return (
    <>
      <Navbar />
      <main className="flex min-h-[calc(100vh-64px)] flex-col items-center justify-center bg-gray-50 px-5">
        <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl">
          <div className="mb-8 text-center">
            <h1 className="text-3xl font-extrabold tracking-tight text-[#191c1d]">
              Bienvenido de nuevo
            </h1>
            <p className="mt-2 text-sm text-[#5d616b]">
              Inicia sesión para acceder a tus agentes y backlogs.
            </p>
          </div>
          ...
          <p className="mt-8 text-center text-xs text-[#5d616b]">
            Al continuar, aceptas nuestros{" "}
            <Link href="#" className="underline hover:text-[#191c1d]">
